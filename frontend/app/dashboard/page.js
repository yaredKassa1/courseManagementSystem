...
export default function DashboardPage() {
  return (
    <ProtectedRoute allowedRoles={["ROLE_ADMIN"]}>
      <div className="min-h-screen bg-gradient-to-r from-indigo-600 to-pink-600 p-9 text-white">
...
function DashboardCard({ title, link }) {
  return (
    <Link
      href={link}
      className="bg-white text-indigo-700 p-7 rounded-xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-1"
    >
